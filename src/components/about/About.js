...
export const About = () => {
  return (
    <section className="about">
      ...
      <p className="about__text">
        Весь функционал доступен бесплатно для использования и предоставляется
        автором в образовательных целях.
      </p>
      <p className="about__text">
        Веб сайт адаптивен к мобильным и позволяет посещать его с
        разных устройств, но все же лучше использовать экран побольше.
      </p>
      <p className="about__text">
